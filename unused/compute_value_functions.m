...
Vk(N, :) = prod(double(Y(2:3:end, :) >= 0.8 & ...
                  Y(1:3:end, :) >= target_set_x(1:2:end) & ...
                  Y(1:3:end, :) <= target_set_x(2:2:end)),1); 


for k = N-1:-1:1

    Vk(k, :) = prod(double(Y(2:3:end, :) >= 0.8 & ...
                  Y(1:3:end, :) >= target_set_x(1:2:end) & ...
                  Y(1:3:end, :) <= target_set_x(2:2:end)),1)+ ...
               prod(double(Y(2:3:end, :) >= 0.1& ...
                  Y(1:3:end, :) >= safe_set_x(1:2:end)& ...
                  Y(1:3:end, :) <= safe_set_x(2:2:end)& ...
                  Y(2:3:end, :) < 0.8 & ...
                  Y(1:3:end, :) < target_set_x(1:2:end)& ...
                  Y(1:3:end, :) > target_set_x(2:2:end)),1).*(Vk(k+1, :)*Beta); 
end
