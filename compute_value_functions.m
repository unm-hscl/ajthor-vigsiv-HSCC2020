...
Vk(N, :) = prod(double(Y(3:6:end, :) >= 0.8& ...
                  Y(1:6:end, :) >= target_set_x(1:2:end)& ...
                  Y(1:6:end, :) <= target_set_x(2:2:end)) ,1); 


for k = N-1:-1:1

    Vk(k, :) = prod(double(Y(3:6:end, :) >= 0.8& ...
                  Y(1:6:end, :) >= target_set_x(1:2:end)& ...
                  Y(1:6:end, :) <= target_set_x(2:2:end)),1)+ ...
               prod(double(Y(3:6:end, :) >= 0 & ...
                  Y(1:6:end, :) >= safe_set_x(1:2:end)& ...
                  Y(1:6:end, :) <= safe_set_x(2:2:end)&...
                  Y(3:6:end, :) < 0.8 & ...
                  Y(1:6:end, :) < target_set_x(1:2:end)& ...
                  Y(1:6:end, :) > target_set_x(2:2:end)),1).*(Vk(k+1, :)*Beta); 
end
